...
PROJECT_KEY = 'KAN'
meta_url = f"{JIRA_URL}/rest/api/3/issue/createmeta?projectKeys={PROJECT_KEY}&issuetypeNames=Task&expand=projects.issuetypes.fields"
...
if response.status_code != 200:
    ...
    raise SystemExit
meta = response.json()
print(json.dumps(meta, indent=2)[:10000])
